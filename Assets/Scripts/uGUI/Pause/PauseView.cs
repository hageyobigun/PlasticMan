...
{    
    ...
    {
        pauseMenu.transform.DOLocalMoveX(menuSetPos, 0.5f).SetEase(Ease.OutBounce);//横から出す
    ...
    {
        pauseMenu.transform.DOLocalMoveX(menuSetPos - menuFadePos, 0.5f).SetEase(Ease.InOutBack);//横に戻す
